...
namespace InventoryManagement.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CreateTime,Name,CurrentStoreValue,ProductCategoryId,ProductTypeId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreateTime,Name,CurrentStoreValue,ProductCategoryId,ProductTypeId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
