...
namespace InventoryManagement.DbModels
{
    ...
    public class Entry : BaseModel
    {
        ...
        [Column("SuppliedProductUnitPrice"), Required(ErrorMessage = "মালের একক মুল্য লিখতে হবে"), Display(Name = "একক মুল্য", Prompt = "একক মুল্য লিখুন"), Range(0, float.MaxValue, ErrorMessage = "মালের সঠিক একক মুল্য লিখুন"), DataType(DataType.Currency, ErrorMessage = "দয়া করে একক মুল্য লিখুন")]
